...
object ClientModuleHandler {
  ...
  import OverviewHandler.OverviewModuleInfo
  import ActorHandler.ActorModuleInfo, ActorsHandler.ActorsModuleInfo
  import DeviationHandler.DeviationModuleInfo, DeviationsHandler.DeviationsModuleInfo
  import PlayRequestHandler.PlayRequestModuleInfo, PlayRequestsHandler.PlayRequestsModuleInfo
  ...
  final val oneTimeHandlers = Seq(RequestModule, DeviationModule, LifecycleModule)
