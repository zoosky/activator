...
object Application extends Controller {
  ...
  def getApplicationModel(app: snap.App) =
    ApplicationModel(
      ...
      Seq("plugins/welcome/welcome", "plugins/code/code", "plugins/compile/compile", "plugins/test/test", "plugins/run/run", "plugins/inspect/inspect", "plugins/monitor/monitor"),
